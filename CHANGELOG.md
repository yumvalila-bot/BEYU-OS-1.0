...
- Tests: 60 engine + 12 real-PostgreSQL service (audit/event/lifecycle/scope assertions) + 31
  transport + 4 AI-boundary cases (new); full repository regression re-run unchanged (see the
