...
pending; the subsequent [full validation checkpoint](BODY_ACTIVATION_VALIDATION_2026-09-20.md)
records 4,444 passing tests, all 32 browsers, source-specific checks and the
observed CI/authentication boundary. Focused proof is not full certification.
