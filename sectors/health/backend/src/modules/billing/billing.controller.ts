...
export class BillingController {
  ...
  @Post("services") @RequirePermission("billing:write") addService(@Body() d: any) { return this.svc.createService(d); }
  ...
  @Post("invoices") @RequirePermission("billing:write") create(@Body() d: any) { return this.svc.createInvoice(d); }
  @Post("payments") @RequirePermission("payment:receive") pay(@Body() d: any) { return this.svc.recordPayment(d); }
}
