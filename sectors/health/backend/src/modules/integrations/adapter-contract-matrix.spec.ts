...
const ADAPTERS: AdapterRow[] = [
  {
    provider: "nhif",
    type: "legacy-stub",
    contractProperties: fullContract("IMPLEMENTED"),
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
    provider: "tra",
    type: "legacy-stub",
  ...
  },
  {
    ...
    type: "legacy-stub",
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      dicomMetadataValidation: "IMPLEMENTED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
  ...
  {
    provider: "fhir_endpoint",
    type: "legacy-stub",
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      fhirMapper: "PARTIALLY_IMPLEMENTED",
      terminologyValidation: "PARTIALLY_IMPLEMENTED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
    provider: "mtuha_submission",
    type: "legacy-stub",
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      deterministicAggregates: "IMPLEMENTED",
      nationalCodeMapping: "EXTERNAL_BLOCKED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
    ...
    contractProperties: fullContract("IMPLEMENTED"),
    liveConnection: "EXTERNAL_BLOCKED",
    notes: "BEYU Finance OS canonical; health emits events only",
  },
  {
  ...
  },
  {
    ...
    contractProperties: fullContract("IMPLEMENTED"),
    liveConnection: "EXTERNAL_BLOCKED",
    notes: "HIVE AI runtime; Noelia single governed identity",
  },
  {
    ...
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      failClosedDenyOnMissingConfig: "IMPLEMENTED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
    ...
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      practitionerLicenceVerification: "PARTIALLY_IMPLEMENTED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
  ...
  },
  {
    ...
    contractProperties: {
      ...fullContract("IMPLEMENTED"),
      noSelfAuthorization: "IMPLEMENTED",
      humanOversightRequired: "IMPLEMENTED",
    },
    liveConnection: "EXTERNAL_BLOCKED",
  },
  {
    provider: "taec_radiation",
    type: "legacy-stub",
    contractProperties: fullContract("PARTIALLY_IMPLEMENTED"),
    liveConnection: "EXTERNAL_BLOCKED",
    notes: "Radiation safety reporting — contract only, no live",
  },
  {
    provider: "practitioner_verification",
    type: "beyu-governed",
    contractProperties: fullContract("PARTIALLY_IMPLEMENTED"),
    liveConnection: "EXTERNAL_BLOCKED",
    notes: "Authoritative licence verification routed via HCM",
  },
];
...
describe("Adapter contract matrix", () => {
  beforeAll(() => {
    ...
    fs.writeFileSync(
      path.join(outDir, "adapter-contract-matrix.json"),
      JSON.stringify(
        {
  ...
  it("every adapter exposes all 17 mandatory contract properties", () => {
    for (const a of ADAPTERS) {
      for (const k of Object.keys(fullContract()))
        expect(a.contractProperties).toHaveProperty(k);
    }
  });
});
